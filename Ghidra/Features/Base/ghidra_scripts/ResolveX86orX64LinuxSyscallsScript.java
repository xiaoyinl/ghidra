...
public class ResolveX86orX64LinuxSyscallsScript extends GhidraScript {
	...
	protected void run() throws Exception {
		...
		//get the noreturn function lists
		List<String> noreturnFunctions = getNoReturnFunctions();
	...
	private List<String> getNoReturnFunctions() {
		List<String> noreturnFunctions = new ArrayList<>();
